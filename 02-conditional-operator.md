...
int main() {
  // Объявляем целочисленные переменные x и abs_x. 
  // В переменной abs_x будем хранить модуль значения переменной x.
  int x, abs_x;
  ...
  if (x >= 0) {
    ...
    // В случае если значение переменной x больше либо равно нулю, 
    // то модуль это и есть значение переменной x.
    abs_x = x;
  } else {
  
    // В случае если значение переменной x меньше нуля, 
    // то модуль это значение переменной x со знаком минус.
    abs_x = -x;
  }
...
int main() {
  // Объявляем целочисленные переменные: a, b, min_value, max_value. 
  // В переменной min_value будем хранить минимальное значение среди 
  // значений переменных a и b, а в max_value - максимальное.
  int a, b, min_value, max_value;

  // Вводим значения перменных a и b с клавиатуры.
  cin >> a >> b;

  // Присваиваем переменной min_value минимальное значение среди 
  // значений переменных а и b, а max_value - максимальное.
  if (a < b) {
...
int main() {
  // Объявляем целочсленные переменные x и y - координаты точки.
  int x, y;
  ...
  if (x > 0) {
    ...
    if (y > 0) {
      ...
      // Здесь x > 0 и y > 0, соответственно точка в первой четверти.
      cout << "1" << endl;
    } else {

      // Здесь x > 0 и y <= 0, соответственно точка в четвертой четверти.
      cout << "4" << endl;
    }
  } else {
    ...
    if (y > 0) {
      ...
      // Здесь x <= 0 и y > 0, соответственно точка во второй четверти.
      cout << "2" << endl;
    } else {
      
      // Здесь x <= 0 и y <= 0, соответственно точка в третьей четверти.
      cout << "3" << endl;
    }
  }
}
